...
* PowerPoint slides from the information meeting are [here](Viz_Challenge_Intro_Presentation.pptx).
* The evaluation rubric for how challenge submissions were scored is available [here](Data_Viz_Challenge_Evaluation_Rubric.pdf).
...
We have developed and posted a rubric for scoring the submissions to the challenge. You can access the rubric [here](Data_Viz_Challenge_Evaluation_Rubric.pdf) so you make sure that your submission checks all of the boxes.
...
[Access the Challenge Datasets Here](data.md)
